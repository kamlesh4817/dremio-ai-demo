...
# Initialize LangChain chat model and conversation memory
#chat_model = ChatOpenAI(model_name="gpt-4o", openai_api_key=OPENAI_API_KEY)
#memory = ConversationBufferMemory(memory_key="chat_history", return_messages=True)
# Initialize Ollama chat model and conversation memory
...
chat_model = ChatGroq(
    ...
    groq_api_key=GROQ_API_KEY        # Make sure to set your GROQ API key
)
